...
// console.log("ABBBBBBBBC".replace("B", "Z")); //AZBBBBBBBC
// console.log("ABBBBBBBBC".replace(/B/g, "Z")); //AZZZZZZZZC
// console.log("ABBBBBBBBC".replaceAll("B", "Z")); //AZZZZZZZZC

// let birth = "2000-12-04";
// const birthData = birth.replaceAll("-", "");
// console.log(birthData); //20001204
