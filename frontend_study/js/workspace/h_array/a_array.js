...
// // 삭제된 값이 Array객체로 리턴
// console.log(datas.splice(1, 1)); //(1) [20]
// // 원본이 바로 적용된다.
// console.log(datas); //(4) [10, 15, 30, 25]
...
// let datas = [10, 20, 15, 30, 25];
// console.log(datas.indexOf(20));//1
// console.log(datas.indexOf(156));//-1
...
// console.log(datas); //(5) [1, 2, 3, 4, 5]

// datas.forEach((data) => {
//     console.log(data);
// }); // 1 2 3 4 5

// map(callback): 기존 값을 callback함수의 리턴값으로 변경시킨다. 작업이 완료된 새로운 Array객체를 리턴한다.
// let datas = [10, 20, 15, 30, 25];
